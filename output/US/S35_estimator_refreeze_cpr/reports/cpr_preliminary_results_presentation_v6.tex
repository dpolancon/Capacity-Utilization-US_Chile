...
\begin{frame}{Technical Choice under Unbalanced Growth}
  \begin{block}{The Technology Frontier}
    Productive capacity $Y^p_t$ is generated on a concave technology frontier---not a neoclassical production function determining factor shares, but a physical capacity schedule mapping capital investment into maximum achievable output under distribution conflict:
...
\begin{frame}{Capacity Utilization \& Elasticity Reconstruction (1945--1973)}
  \begin{itemize}
    ...
    \item \textbf{Historical Path Comparison:}
      \begin{itemize}
        \item \textbf{Specification B (Composition-Mediated):} Captures utilization fluctuations ($\sigma_{\mu} = 12.98\%$), anchored at the 1973 peak ($\mu_{1973}=1.0$).
