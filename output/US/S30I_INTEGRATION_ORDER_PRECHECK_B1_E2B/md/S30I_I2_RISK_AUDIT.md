...
## 1. Executive read
Run tag: `S30I_I2_RISK_AND_ROLLING_AUDIT_B1_E2B`.
...
| D04_i2_corrected_changes | no | none | Do not patch original S30I outputs. |
| D05_original_code_location | codes/US_S30I_integration_order_precheck_B1_E2B.R:435-480 | low | Document the rule and keep failed/skipped rows excluded from audit read. |
