...
Run tag: `S31I_INTEGRATION_ORDER_PRECHECK_B1_E2B`.
Run timestamp: 2026-06-03 16:03:00 -04.

| check | pass | evidence |
|---|---|---|
| Output folders exist | TRUE | C:/ReposGitHub/Capacity-Utilization-US_Chile/output/US/S31I_INTEGRATION_ORDER_PRECHECK_B1_E2B |
