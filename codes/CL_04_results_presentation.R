...
make_zoom_slice <- function(df) {
  df %>% dplyr::filter(year >= 1932, year <= 1978)
}
...
base_theme <- function(x_breaks, x_angle = 90) {
...
make_dual_plot <- function(df, primary_var, secondary_var,
  ...
  g <- g +
    scale_color_manual(
      values = c(
        primary_legend = "black",
        secondary_legend = "#D55E00"
      ),
      name = NULL
    ) +
    scale_linetype_manual(
      values = c(
        primary_legend = "solid",
        secondary_legend = "dashed"
      ),
      name = NULL
    ) +
    scale_y_continuous(
    ...
    base_theme(x_breaks = x_breaks, x_angle = ifelse(mark_every_year, 90, 0)) +
...
full_df <- ts_splice
zoom_df <- make_zoom_slice(ts_splice)
...
make_dual_plot(
  ...
  stem = "dual_u_theta_full_1932_2010",
...
make_dual_plot(
  ...
  primary_legend = "u",
  secondary_legend = "theta",
  stem = "dual_u_theta_zoom_1932_1978",
  yline_at_1_primary = TRUE,
  vline_1973 = TRUE,
...
make_dual_plot(
  ...
  stem = "dual_theta_wsh_full_1932_2010",
  yline_at_1_primary = TRUE,
  vline_1973 = TRUE,
  mark_every_year = FALSE,
  width = 9.2,
...
make_dual_plot(
  ...
  primary_legend = "theta",
  secondary_legend = "wage share",
  stem = "dual_theta_wsh_zoom_1932_1978",
  yline_at_1_primary = TRUE,
  vline_1973 = TRUE,
  mark_every_year = TRUE,
  width = 10.8,
...
make_dual_plot(
  ...
  stem = "dual_theta_ect_full_1932_2010",
  yline_at_1_primary = TRUE,
  vline_1973 = TRUE,
  mark_every_year = FALSE,
  width = 9.2,
...
make_dual_plot(
  ...
  primary_legend = "theta",
  secondary_legend = "ECT",
  stem = "dual_theta_ect_zoom_1932_1978",
  yline_at_1_primary = TRUE,
  vline_1973 = TRUE,
  mark_every_year = TRUE,
  width = 10.8,
...
summary_lines <- c(
  ...
  " - figs/dual_u_theta_full_1932_2010.(png/pdf)",
  " - figs/dual_u_theta_zoom_1932_1978.(png/pdf)",
  " - figs/dual_theta_wsh_full_1932_2010.(png/pdf)",
  " - figs/dual_theta_wsh_zoom_1932_1978.(png/pdf)",
  " - figs/dual_theta_ect_full_1932_2010.(png/pdf)",
  " - figs/dual_theta_ect_zoom_1932_1978.(png/pdf)"
)
