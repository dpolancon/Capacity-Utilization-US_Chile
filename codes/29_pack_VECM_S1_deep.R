...
#
# PACK SCOPE: VECM S1 deep diagnostics (r=1)
# INPUT SCRIPT: 22_VECM_S1.R
# OUTPUT FOLDER: ResultsPack_VECM_S1_22_deep/
# ============================================================
...
# detect if called from Stage 4 orchestrator
CALLED_FROM_STAGE4 <- nzchar(Sys.getenv("CR_RUN_ROOT"))

# standalone fallback (stable sandbox folder)
STANDALONE_FALLBACK_ROOT <- here::here(
  "output",
  "CriticalReplication",
  "ResultsPack",
  "ResultsPack_latest"
...
# ------------------------------------------------------------
# Package root for THIS script (VECM S1 deep, lnY-lnK, r=1)
# ------------------------------------------------------------
OUT_PKG <- file.path(RUN_ROOT, "VECM_S1_lnY_lnK_r1_deep")
