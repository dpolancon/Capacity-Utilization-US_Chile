...
codes/
  ...
  critical_replication/
    ...
    23_VECM_S2_shaikh_window_lnY_lnK_lne.R        # NEW (Stage 4)
    24_complexity_penalties.R                      # NEW (ICOMP/RICOMP_pen)
    25_envelope_tools.R                            # NEW (envelope extraction + plots)
    26_crosswalk_tables.R                          # NEW (crosswalk builders)
    27_run_stage4_all.R                            # NEW (single runner + manifest)
